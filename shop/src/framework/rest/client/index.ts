...
class Client {
  ...
  types = {
    ...
    allTypes: (params?: Partial<TypeQueryOptions>) =>
      // HttpClient.get<Type[]>(API_ENDPOINTS.TYPES, params),
      HttpClient.get<Type[]>('https://pandomart-bazaar.herokuapp.com/api/v1/categories', params),
    get: (slug: string) =>
  ...
  users = {
    ...
    login: (input: LoginUserInput) =>
      HttpClient.post<AuthResponse>('https://pandomart-bazaar.herokuapp.com/api/v1/auth/login', input),
    // login: (input: LoginUserInput) =>
    ...
    OtpLogin: (input: OtpLoginInputType) =>
      HttpClient.get<AuthResponse>(`https://pandomart-bazaar.herokuapp.com/api/v1/auth/verify/${input.token}`, input),
    // OtpLogin: (input: OtpLoginInputType) =>
    //   HttpClient.post<AuthResponse>(API_ENDPOINTS.OTP_LOGIN, input),
    register: (input: RegisterUserInput) =>
      HttpClient.post<AuthResponse>('https://pandomart-bazaar.herokuapp.com/api/v1/auth/register', input),
    forgotPassword: (input: ForgotPasswordUserInput) =>
      HttpClient.post<PasswordChangeResponse>(
        'https://pandomart-bazaar.herokuapp.com/api/v1/auth/password-request',
        input
      ),
    ...
    resetPassword: (input: ResetPasswordUserInput) =>
      HttpClient.put<PasswordChangeResponse>(
        'https://pandomart-bazaar.herokuapp.com/api/v1/auth/password-reset',
        input
      ),
