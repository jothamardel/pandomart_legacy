...
import { productPlaceholder, cover } from '@/lib/placeholders';
              ...
              <SwiperSlide key={idx}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      {/* {banner?.title} */}
                      Everything your automobile needs
                    </h1>
                    <p className="text-sm lg:text-base xl:text-lg text-heading">
                      {/* {banner?.description} */}
                      Get best automobile services and original products all day everyday
                    </p>
